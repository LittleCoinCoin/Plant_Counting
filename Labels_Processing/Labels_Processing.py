...
def Produce_Adjusted_Position_Files( _path_position_file,
    ...
    posFile_content = open(_path_position_file+"/"+"/captures_000.json", 'r')
    position_file = _path_adjusted_position_file+
...
if (__name__ == "__main__"):
    Produce_Adjusted_Position_Files(
            ...
            "D:\Projet\Unity\HDRP_PGoCF\Datasets\Monitoring\Series_9\2021_02_18_10_05"+"/Output/Session_{0}".format(1)+"/Adjusted_Position_Files",
            80,
