...
# =============================================================================
        ...
        if (p_value < 0.0001):
            ...
            index_small_grp = np.ravel((_indeces_grp0, _indeces_grp1)[min_mean_group_index])

            # convert the array index_small_grp to a list of indeces
            index_small_grp = list(index_small_grp)
